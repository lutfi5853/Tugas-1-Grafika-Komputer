...
void Demo::DrawTailRotate()
{
	...
	glm::mat4 model;
	model = glm::translate(model, glm::vec3(6.6, 1, 0));
...
int main(int argc, char** argv) {
	...
	app.Start("Tugas 1", 800, 600, false, false);
}